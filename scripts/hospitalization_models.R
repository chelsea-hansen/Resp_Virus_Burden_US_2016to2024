...
resp_any = bootstrap_block_residual(dat=dat,
                                      y_value="hosp_resp_any_rate_smooth", 
                                      ages=ages, 
                                      lags = c(rep(0,5)),
...
saveRDS(resp_any,"main_results/hosp_resp_any.rds")


# Respiratory First Position ----------------------------------------------
resp_first = bootstrap_block_residual(dat=dat,
                                      y_value="hosp_resp_1st_rate_smooth", 
                                      ages=ages, 
                                      lags = c(rep(0,5)),
                                      include_viruses_A = include_viruses,
                                      include_viruses_B = include_viruses,
...
saveRDS(resp_first,"main_results/hosp_resp_1st.rds")

# Respiratory or Circulatory First Position -------------------------------
rc_first = bootstrap_block_residual(dat=dat,
                                      y_value="hosp_respcirc_1st_rate_smooth", 
                                      ages=ages, 
                                      lags = c(rep(0,5)),
                                      include_viruses_A = include_viruses,
                                      include_viruses_B = include_viruses,
...
saveRDS(rc_first,"main_results/hosp_respcirc_1st.rds")
