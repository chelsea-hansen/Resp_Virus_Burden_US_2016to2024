...
hosp_model1 = readRDS("main_results/hosp_resp_any.rds")
hosp_model2 = readRDS("main_results/hosp_resp_1st.rds")
hosp_model3 = readRDS("main_results/hosp_respcirc_1st.rds")
