...
figS4 = ggplot(hosp_avg %>% filter(model != "Ensemble")) +
  theme_bw() +
  ...
  figS4
ggsave(plot=figS4,"figures/figureS4.png",height=8.5,width=11,units="in")
ggsave(plot=figS4,"figures/TIFF/figureS4.tiff",height=8.5,width=11,units="in")
...
figS7=ggplot(mort_avg %>% filter(model != "Ensemble")) +
  theme_bw() +
  # Background rectangle for Ensemble 95% CI
  geom_rect(
...
figS7
ggsave(plot=figS7,"figures/figureS7.png",height=8.5,width=11,units="in")
ggsave(plot=figS7,"figures/TIFF/figureS7.tiff",height=8.5,width=11,units="in")
